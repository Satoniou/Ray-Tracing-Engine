...
public:
	...
	double focus_dist{ 10 };			// Distance from camera loofrom point to plane of perfect focus
...
private:
	...
	{
		// Returns the vector to a random point in the unit square centered at the origin
